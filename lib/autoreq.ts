...
if (args.length < 1) {
    ...
    var date = new Date();
    var version = date.getFullYear() + Format2Digit(date.getMonth() + 1) + Format2Digit(date.getDay()) + "T" + Format2Digit(date.getHours()) + Format2Digit(date.getMinutes()) + Format2Digit (date.getSeconds());
